...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function init() {
        ...
        if (savedStartTime && savedTimeRemaining) {
            ...
            examTimeRemaining = parseInt(savedTimeRemaining);
            let elapsedSeconds = Math.floor((Date.now() - examStartTime) / 1000);
            examTimeRemaining = examTimeRemaining - elapsedSeconds;
